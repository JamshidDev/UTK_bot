...
<i>📞 Telefon raqamingizni yuboring!</i>`, {
    ...
    conversation.session.session_db.client.phone = ctx.message.contact.phone_number;
...
async function salary_show_conversation(conversation, ctx) {
    ...
    ctx = await conversation.wait()
    let months = ['Yanvar', 'Fevral', 'Mart', 'Aprel', 'May', 'Iyul', 'Iyun', 'Avgust', 'Sentyabr', 'Oktyabr', 'Noyabr', 'Dekabr']
